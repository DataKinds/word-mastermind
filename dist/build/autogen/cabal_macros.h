...
/* package word-mastermind-0.1.0.0 */
#define VERSION_word_mastermind "0.1.0.0"
#define MIN_VERSION_word_mastermind(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "word-mastermind-0.1.0.0-CkzWU5ICk1JK46IFDyI1Xr"

#define CURRENT_PACKAGE_KEY "word-mastermind-0.1.0.0-CkzWU5ICk1JK46IFDyI1Xr"
